---
name: "code-review"
description: "Reviews existing Rails code for defects, regressions, security risks, performance problems, missing tests, and maintainability issues without modifying code. Use for code review, implementation review, architecture audit, or when the user asks to review files or recent code changes."
---
