...
description: "Tailwind CSS 4 utility patterns, responsive layouts, component styling, accessibility, and Hotwire integration for Rails 8.x ERB views and ViewComponents. Reference material for Tailwind CSS styling."
---

<!-- Codex transposition: omitted Claude-specific frontmatter fields: user-invocable. -->

# Tailwind CSS Patterns for Rails 8.x
...
5. **Run Tests:** `bin/rails test test/components/` to ensure component behavior
