...
class NotificationsChannelTest < ActionCable::Channel::TestCase
  ...
  test "successfully subscribes" do
    subscribe
...
class EventsChannelTest < ActionCable::Channel::TestCase
  ...
  test "rejects subscription to unauthorized event" do
...
class ChatTest < ApplicationSystemTestCase
  ...
  test "sends and receives messages in real-time" do
