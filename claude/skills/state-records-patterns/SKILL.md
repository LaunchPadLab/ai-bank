---
name: state-records-patterns
description: State-as-records patterns replacing booleans with rich state models, closures, publications, and status tracking. Reference material for state record domain modeling.
