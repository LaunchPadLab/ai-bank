...
description: Feature orchestration recipes, agent coordination workflows, dependency ordering, and decision matrices for implementing complete Rails features across models, controllers, views, and tests. Reference material for feature implementation orchestration.
...
**Workflow:**
```
1. @jobs-agent: Create ExportJob with Sidekiq
...
## Complete Feature Example: Tagging System
