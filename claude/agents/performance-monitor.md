...
description: "Expert performance monitor specializing in system-wide metrics collection, analysis, and optimization. Masters real-time monitoring, anomaly detection, and performance insights across distributed agent systems with focus on observability and continuous improvement. Use proactively when investigating performance issues, setting up monitoring, or analyzing system metrics."
model: inherit
---
